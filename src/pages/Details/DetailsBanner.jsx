...
const DetailsBanner = ({ video, crew }) => {
  ...
  const writer = crew?.filter(
    (filt) =>
      filt.job === "Writer" || filt.job === "Story" || filt.job === "Screenplay"
  );
                ...
                <div className="content">
                  <div className="leftBanner">
                    {data.poster_path ? (
                      ...
                      <LazyLoadImg src={poster} className="posterImg" />
                    )}
                  </div>
                  ...
                  <div className="rightBanner">
                    ...
                    <div className="rightSubTitle">{data.tagline}</div>
                    ...
                    <div className="row">
                      ...
                      >
                        <PlayButton />
                        <div className="playtext">Trailer</div>
                      </div>
                    </div>
